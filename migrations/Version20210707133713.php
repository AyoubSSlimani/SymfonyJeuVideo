 ...
 */
final class Version20210707133713 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE game ADD CONSTRAINT FK_232B318C29CCBAD0 FOREIGN KEY (forum_id) REFERENCES game (id)');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_232B318C29CCBAD0 ON game (forum_id)');
        $this->addSql('ALTER TABLE post_category ADD post_category_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE post_category ADD CONSTRAINT FK_B9A19060FE0617CD FOREIGN KEY (post_category_id) REFERENCES game (id)');
        $this->addSql('CREATE INDEX IDX_B9A19060FE0617CD ON post_category (post_category_id)');
        $this->addSql('ALTER TABLE topic ADD game_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE topic ADD CONSTRAINT FK_9D40DE1BE48FD905 FOREIGN KEY (game_id) REFERENCES game (id)');
        $this->addSql('CREATE INDEX IDX_9D40DE1BE48FD905 ON topic (game_id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post_category DROP FOREIGN KEY FK_B9A19060FE0617CD');
        $this->addSql('DROP INDEX IDX_B9A19060FE0617CD ON post_category');
        $this->addSql('ALTER TABLE post_category DROP post_category_id');
        $this->addSql('ALTER TABLE topic DROP FOREIGN KEY FK_9D40DE1BE48FD905');
        $this->addSql('DROP INDEX IDX_9D40DE1BE48FD905 ON topic');
        $this->addSql('ALTER TABLE topic DROP game_id');
    }
}
